#!/bin/bash
# Hermes Infrastructure Bootstrap Script v2.0
...
# Generated by bootstrap.sh v2.0
...
auto_deploy_stack() {
    ...
    if hermes chat -q "Deploy the monitoring stack from https://raw.githubusercontent.com/rylanddufour/AIAMSBS/main/GOAL.md"; then
        ...
        log_info "  hermes chat -q 'Deploy the monitoring stack from https://raw.githubusercontent.com/rylanddufour/AIAMSBS/main/GOAL.md'"
    fi
}
...
main() {
    ...
    echo ""
    echo "============================================"
    echo "  Hermes Infrastructure Bootstrap v2.0"
    echo "============================================"
    echo ""
    echo "  Provider: $PROVIDER"
    echo "  Model: ${MODEL:-default}"
